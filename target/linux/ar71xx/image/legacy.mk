...
maselink_ap2600ifm_mtdlayout=mtdparts=spi0.0:256k(breed)ro,256k(breed-env)ro,1536k(kernel),14336k(rootfs),15872k@0x50000(firmware)
...
$(eval $(call SingleProfile,AthLzma,256k,AP2600IFM,maselink-ap2600ifm,AP2600IFM,ttyS0,115200,$$(maselink_ap2600ifm_mtdlayout) ahbskip=1,KRuImage))
